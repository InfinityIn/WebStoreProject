...
namespace WebStoreProject.Commands.OrderCommands
{
    public class PatchOrderCommandHandler
        : IRequestHandler<PatchOrderCommand.Request, PatchOrderCommand.Response>
    {
        public PatchOrderCommandHandler(StorageContext storageContext) => _storageContext = storageContext;

        private readonly StorageContext _storageContext;
        public async Task<PatchOrderCommand.Response> Handle(PatchOrderCommand.Request request, CancellationToken cancellationToken)
        {
            ...
            return new PatchOrderCommand.Response() { };
        }
        ...
        {            
            ...
            if (oldOrder.ClientName != order.ClientName)
